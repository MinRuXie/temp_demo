$(function() {
    ...
    $('.js-logo-dark').load('/assets/images/general/svg_fixed/brand.svg');
    $('.js-logo-white').load('/assets/images/general/svg_fixed/brand.svg');
    $('.js-logo-footer').load('/assets/images/general/svg_fixed/brand_footer.svg');
