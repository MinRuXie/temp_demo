...
function cnVeryCalendar() {
    ...
    this.generateCalendarTable = function () {
        ...
        body += "    <div style='color:" + fore_frameCaption + "; float:left'><b>選擇日期</b></div>";
        body += "    <div style='float:right'>";
        body += "     <a href=\"javascript:calendar.setValue('')\" style='color:" + fore_frameCaption + "; text-decoration:none;" + font_cnChar + "'>[重設]</a> ";
        body += "     <a href='javascript:calendar.fadeOut()' style='color:" + fore_frameCaption + "; text-decoration:none;" + font_cnChar + "'>[關閉]</a>";
        body += "    </div>";
        body += "   </td>";
        body += " </tr>";
        body += " <tr>";
